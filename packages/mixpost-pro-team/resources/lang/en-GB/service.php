...
return [
    ...
    'giphy' => [
        'search_gifs' => 'Search Giphy GIFs',
        'gif' => 'GIF from Giphy',
        'use_gif' => 'With Giphy you can use GIF\'s directly in Mixpost.',
    ],
    'unsplash' => [
    ...
    'tiktok' => [
        ...
        'ai_generated_content_desc' => 'Add this label to tell viewers your content was generated or edited with AI.',
    ],
    'pinterest' => [
    ...
    'mastodon' => [
        ...
        'server' => 'Server',
        'mastodon_apps_desc' => 'Mastodon applications are created automatically when users connect their accounts. You can manage them here.',
        'no_mastodon_apps' => 'No Mastodon applications have been created yet.',
        'delete_mastodon_app' => 'Delete Mastodon Application',
        'confirm_delete_mastodon_app' => 'Are you sure you want to delete this Mastodon application? All associated accounts will be set to unauthorized.',
        'recreate_mastodon_app' => 'Recreate Mastodon Application',
        'confirm_recreate_mastodon_app' => 'Are you sure you want to recreate this Mastodon application? All Mastodon accounts from this server will need to re-authorize.',
        'recreate_app' => 'Recreate',
        'service_deleted' => ':service service has been deleted',
    ],
